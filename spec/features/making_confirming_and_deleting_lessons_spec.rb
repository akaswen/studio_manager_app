...
RSpec.feature "MakingLessons", type: :feature do
  ...
  it("doesn't allow a student to make a lesson 15 minutes before another confirmed lesson", js: true) do
    start_time = Time.now.utc.beginning_of_day + 12.hours + 15.minutes + 1.day
    i = 0
    until start_time.wday == 0 || i > 14
